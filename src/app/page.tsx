        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-[15px] sm:text-base text-zinc-100 leading-relaxed max-w-xl mx-auto mb-3.5 font-medium sm:font-normal drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              ...
              and physical infrastructure), deploying capital automatically and routing machine revenue back 
              to the vault.
            </p>
...
function PillarMatrix() {
  const pillars = [
    ...
    },
    {
      ...
      desc: "When the revenue channel activates, earnings from approved compute operators will be paid into the ERC-4626 vault every block, compounding the Net Asset Value (NAV) of TRN without lockup barriers.",
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <FadeIn delay={0.15} className="lg:col-span-6">
            <div className="border border-white/15 bg-[#0a0a0d] p-5 sm:p-8 shadow-2xl">
              ...
              <p className="mt-4 text-[11px] text-[#8E8E95] text-center leading-relaxed">
                Simulates the contract-defined boost tiers. The yield engine is not live yet; real rates will
                appear once the revenue channel activates.
              </p>
            </div>
          </FadeIn>
  ...
  const faqs = [
    {
      ...
      a: "Theron is an autonomous AI fund manager built natively on BOT Chain. It evaluates physical compute hardware (GPUs, CPUs, validator nodes) across decentralized physical infrastructure networks (DePIN), scores their uptime and revenue performance, and deploys fund capital to top operators. In this mainnet deployment, the underwriting and allocation engine is live, while the yield engine is a future integration: BOT Chain does not yet offer a mature revenue venue, so the fund currently generates no returns. When the revenue channel activates, machine earnings will flow into the vault and compound the Net Asset Value (NAV) of TRN shares.",
    },
    {
